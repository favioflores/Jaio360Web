...
@ManagedBean(name = "stepSixView")
@ViewScoped

public class stepSixView extends BaseView implements Serializable {

    private static Logger log = Logger.getLogger(stepSixView.class);
