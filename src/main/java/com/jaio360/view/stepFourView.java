...
@ManagedBean(name = "stepFourView")
@ViewScoped

public class stepFourView extends BaseView implements Serializable {

    private static Logger log = Logger.getLogger(stepFourView.class);
