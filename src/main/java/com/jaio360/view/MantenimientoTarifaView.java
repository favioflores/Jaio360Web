...
public class MantenimientoTarifaView extends BaseView implements Serializable {
    ...
    private List<TarifaBean> obtenerListaTarifas() {
        ...
        for (Tarifa objTarifa : lstTarifas) {
            ...
            objTarifaBean.setTaTxEstado(msg(objTarifa.getTaIdEstado() + ""));
    ...
    private List<SelectItem> obtieneEstados() {
        ...
        List<Elemento> lstElementos = objElementoDAO.obtenListaElementoXDefinicion(Constantes.INT_DT_ESTADOS_TARIFA);
