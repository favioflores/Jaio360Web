...
public class ReporteIndividualSumarioCategoria implements Serializable {

    private static final Logger log = Logger.getLogger(ReporteIndividualSumarioCategoria.class);
                            ...
                            cmp.verticalList(
                                    ...
                                    cmp.horizontalList(
                                            cht.barChart().setCategory(evaluacion)
                                                    ...
                                                    .addCustomizer(new ReporteIndividualSumarioCategoria.ChartCustomizerBar()),
    ...
    private ComponentBuilder<?, ?> crearDatosDelGrafico(Componente objComponente, Integer intEvaluadoPk, ReporteGenerado objReporteGenerado) {
        ...
        List lstResultadoFinal = this.resultadoDAO.listaReporteSumario(objComponente, intEvaluadoPk, objReporteGenerado);
