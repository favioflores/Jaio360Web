...
public class ReporteIndividualSumarioCategoriaMismoRelacionWeighted implements Serializable {
    ...
    private static final Log log = LogFactory.getLog(ReporteIndividualSumarioCategoriaMismoRelacionWeighted.class);
    ...
    private ComponentBuilder<?, ?> crearDatosDelGrafico(Componente objComponente, Integer intEvaluadoPk) {
        ...
        List lstResultadoFinal = this.resultadoDAO.listaReporteSumarioMismoRelacionWeighted(objComponente, intEvaluadoPk);
