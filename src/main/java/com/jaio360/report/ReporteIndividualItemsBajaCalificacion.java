...
public class ReporteIndividualItemsBajaCalificacion implements Serializable {
    ...
    private static final Logger log = Logger.getLogger(ReporteIndividualItemsBajaCalificacion.class);
    ...
    private MultiPageListBuilder generaContenido(Integer intEvaluadoPk, ReporteGenerado objReporteGenerado) {
        ...
        List lstItems = resultadoDAO.listaItemsBajaPromedio(intEvaluadoPk, objReporteGenerado.getProyectoInfo().getIntIdProyecto());
