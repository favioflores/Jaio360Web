...
public class ReporteIndividualCalificacionXCategoriaWeighted implements Serializable {
    ...
    private static final Log log = LogFactory.getLog(ReporteIndividualCalificacionXCategoriaWeighted.class);
    ...
    private ComponentBuilder<?, ?> crearDatosDelGrafico(Componente objComponente, Integer intEvaluadoPk) {
        ...
        List lstResultadoFinal = this.resultadoDAO.listaReporteUnoWeighted(objComponente, intEvaluadoPk);
