...
public class ReporteIndividualCalificacionXCategoriaWeighted implements Serializable {

    private static final Logger log = Logger.getLogger(ReporteIndividualCalificacionXCategoriaWeighted.class);
                            ...
                            cmp.verticalList(
                                    ...
                                    cmp.horizontalList(
                                            cht.barChart().setCategory(evaluacion)
                                                    ...
                                                    .addCustomizer(new ReporteIndividualCalificacionXCategoriaWeighted.ChartCustomizerBar()),
    ...
    private ComponentBuilder<?, ?> crearDatosDelGrafico(Componente objComponente, Integer intEvaluadoPk, ReporteGenerado objReporteGenerado) {
        ...
        List lstResultadoFinal = this.resultadoDAO.listaReporteUnoWeighted(objComponente, intEvaluadoPk, objReporteGenerado.getProyectoInfo().getIntIdProyecto());
