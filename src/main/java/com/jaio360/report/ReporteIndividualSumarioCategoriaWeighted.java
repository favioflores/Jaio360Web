...
public class ReporteIndividualSumarioCategoriaWeighted implements Serializable {
    ...
    private static final Log log = LogFactory.getLog(ReporteIndividualSumarioCategoriaWeighted.class);
    ...
    private ComponentBuilder<?, ?> crearDatosDelGrafico(Componente objComponente, Integer intEvaluadoPk) {
        ...
        List lstResultadoFinal = this.resultadoDAO.listaReporteSumarioWeighted(objComponente, intEvaluadoPk);
