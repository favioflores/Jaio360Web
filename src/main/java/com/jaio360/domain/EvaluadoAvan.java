...
public class EvaluadoAvan implements Serializable {
    ...
    private String strImgEvado;
    private String strImgEvador;
    ...
    public void setStrImgEvado(String strImgEvado) {
        this.strImgEvado = strImgEvado;
    }

    public String getStrImgEvador() {
        return strImgEvador;
    }

    public void setStrImgEvador(String strImgEvador) {
        this.strImgEvador = strImgEvador;
    }
